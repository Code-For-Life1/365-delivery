...
class _MerchantPlaceNewOrder extends State<MerchantUpdateOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    String receiverFullName = widget.selectedOrderDetails['receiver_full_name'];
    String receiverPhoneNumber = widget.selectedOrderDetails['receiver_phone_number'];
    String street = widget.selectedOrderDetails['street'];
    ...
    final TextEditingController buildingController = TextEditingController(text: building);
